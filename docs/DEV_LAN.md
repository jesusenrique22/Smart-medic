...
Backend (**3000**), gateway (**3001**) y Flutter web (**8080** por defecto) deben estar activos.
...
O en Cursor: **Run and Debug** → **Flutter Web (LAN · puerto 8080)**.
...
En la pestaña **Puertos**, añade **8080**, **3000** y **3001** si quieres reenvío; en LAN suele bastar la IP directa.
...
| `http://127.0.0.1:8080` | **App Flutter web** | pantalla de login |
...
- `http://DEV_HOST:8080` → app Flutter
